...
def search_contact():
    ...
    for list in data:
        if search_for in list:
            print(tabulate([list], headers=["Company", "First name",
...
def edit_contact():
    ...
    search_result = input('[s]earch again or [c]ontinue or e[x]it? s/c/x: \n')
...
def remove_contact():
    ...
    edit_list = input('Enter index on record you want to remove or \
